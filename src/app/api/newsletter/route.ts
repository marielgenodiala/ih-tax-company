...
<body style="margin:0;padding:0;background:#f7f8fc;font-family:'DM Sans',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f7f8fc;padding:40px 0;">
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,0.08);">
        ...
        <tr>
          <td style="background:#0b1024;padding:32px 40px;text-align:center;">
            ...
            <h1 style="margin:0;font-size:22px;font-weight:700;color:#ffffff;">Newsletter Signup</h1>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:32px 40px;">
            <p style="margin:0 0 24px;font-size:15px;color:#4b5563;">Below are the details of the form submission:</p>
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;">
              <tr>
                <td style="padding:10px 16px;font-weight:600;color:#111827;width:40%;font-size:14px;">Email</td>
                <td style="padding:10px 16px;color:#4b5563;font-size:14px;">
                  <a href="mailto:${email}" style="color:#334ed7;">${email}</a>
                </td>
              </tr>
            </table>
          </td>
    ...
    await resend.emails.send({
      ...
      subject: `New Newsletter Signup — IH Professionals`,
      html,
    });
